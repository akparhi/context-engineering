...
Review target: the git scope given in the task message (working tree, or `<base>...HEAD`).
Read the diff and surrounding code yourself with your tools. Do not edit files.
